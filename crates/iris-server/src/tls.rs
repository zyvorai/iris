...
/// Resolve the TLS configuration iris-server binds with.
///
/// Prefers an operator-supplied cert/key (`IRIS_TLS_CERT` / `IRIS_TLS_KEY`).
...
///
/// When `IRIS_TLS_SAN_HOSTS` changes (e.g. redeploy to a public IP), the stored
...
pub async fn resolve(
    ...
    if reuse {
        ...
        tracing::warn!(
            "IRIS_TLS_CERT/IRIS_TLS_KEY not set — generated a self-signed certificate at {} \
